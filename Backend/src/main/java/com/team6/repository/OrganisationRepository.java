...
public interface OrganisationRepository extends JpaRepository<OrganisationsInfo, Integer>{
	...
	@Query("SELECT org.status from OrganisationsInfo org WHERE org.organisationId=:organisationId")
	public String findNgoStatusById(@Param(value = "organisationId")int organisationId);
